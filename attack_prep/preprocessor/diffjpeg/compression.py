...
class rgb_to_ycbcr_jpeg(nn.Module):
    ...
    def __init__(self):
        ...
        self.register_buffer('shift', torch.tensor([0., 128., 128.], dtype=torch.float32),
                             persistent=False)
...
class chroma_subsampling(nn.Module):
    ...
    def __init__(self):
        ...
        self.avg_pool = nn.AvgPool2d(kernel_size=2, stride=(2, 2), count_include_pad=False)
...
class dct_8x8(nn.Module):
    ...
    def __init__(self):
        ...
        self.register_buffer('scale', torch.from_numpy(
            np.outer(alpha, alpha) * 0.25).float(), persistent=False)
